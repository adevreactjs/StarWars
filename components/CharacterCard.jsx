...
function CharacterCard({ character }) {
  const locations = [character?.bornLocation, character?.diedLocation, character?.homeworld];
  ...
  return (
    <>
      ...
      <CardContainer>
        <Image className='image' src={character?.image} alt='Image' width={600} height={400} />
        <CharacterInfo>
